...
def process():
    ...
    with open('./src/index.html', 'r') as f:
        ...
        subjects = extract_subjects(sorted_days, sorted_times, i_end_time, timetable)
        ...
        for sub in subjects:
            c.events.add(
                Event(
                    ...
                    location=sub.place,
                    description=', '.join(sub.profs),
                )
            )
    with open('./src/schedule.ics', 'w') as s_f:
        s_f.write(c.serialize())
